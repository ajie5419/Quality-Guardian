...
export function parseAfterSalesListQuery(
  ...
  return {
    ...
    defectCategoryId: normalizeQueryText(query.defectCategoryId),
    defectSubcategoryId: normalizeQueryText(query.defectSubcategoryId),
    ...
    productCategoryId: normalizeQueryText(query.productCategoryId),
    productSubcategoryId: normalizeQueryText(query.productSubcategoryId),
