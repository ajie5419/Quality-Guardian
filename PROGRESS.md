...
- 最新变更: 后端类型感知 lint、Git hooks 分层门禁和供应商异常收窄已通过 PR #56/#57 发布为 `qgs-v0.17.3`，生产 ECS、migration、身份回填和 HTTP 健康检查已通过
- 测试状态: 本次全仓 290/290 个文件、2480/2480 个用例通过，其中后端 213/213 个文件、1991/1991 个用例通过
