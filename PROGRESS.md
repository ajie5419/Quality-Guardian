...
- 最新变更: 同名软删除供应商恢复修复已通过 PR #53/#54 发布为 `qgs-v0.17.2`，生产 ECS 更新、migration 检查和 HTTP 健康检查已通过
- 测试状态: 本次全仓 290/290 个文件、2479/2479 个用例通过，其中后端 213/213 个文件、1990/1990 个用例通过
