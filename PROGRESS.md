...
- 最新变更: 售后质量已增加部件名称搜索，报检派单仅显示启用的 `QC` 检验员，调试验收问题台账指定操作已图标化；生产当前仍为 `qgs-v0.17.6`
- 测试状态: 本次后端 221/221 个文件、2082/2082 个用例通过；售后共享查询 7/7、前端搜索构造 5/5、后端查询 18/18 通过；派单与用户服务后端 42/42、前端检验员选项 2/2 通过
