...
- 最新变更: 本地 Apple Container 启动端口检查阻塞已修复；生产当前仍为 `qgs-v0.17.6`
- 测试状态: 本次后端 221/221 个文件、2074/2074 个用例通过；共享查询 7/7 个用例通过；前端本次定向 2/2 个文件、11/11 个用例通过
...
├── modules/      # 业务逻辑（25 个模块，513 个 TS 文件）
