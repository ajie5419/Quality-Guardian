...
These scripts collectively provide a comprehensive business consultation application, leveraging advanced AI and interactive web interfaces to deliver strategic insights and detailed reports. </script_explanations>   
...
<user_task> I ran the main file, ‘business_consulting_chatbot.py”’ and the page opened up. However, when I pressed the “Start Interview” button, it gave me the message:   “System: An error occurred while starting the interview.” </user_task>
...
<problematic_code>  {{PROBLEMATIC_CODE}}  </problematic_code>
...
<step_by_step_reasoning>  {{STEP_BY_STEP_REASONING}}  </step_by_step_reasoning>  
...
<debug_instructions>  {{DEBUG_INSTRUCTIONS}}  </debug_instructions>
