...
1.  **Spec-Driven Development**: Always begin with a `specification.md` that defines the _what_ and _why_ before deciding the _how_.
...
_Note: This framework is adapted from the obra/superpowers methodology._
