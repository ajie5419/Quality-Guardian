...
import DeadlineBoard from './DeadlineBoard.vue';
        ...
        <Card>
          ...
          <template v-else>
            <div class="mb-3 grid grid-cols-2 gap-2 md:grid-cols-6">
              ...
              <div class="rounded bg-red-50 px-3 py-2 text-center text-red-700">
        ...
        <Card>
          ...
          <div class="hidden md:block">
            <Table
              ...
              :pagination="{ pageSize: 10 }"
            >
              <Table.Column title="日期" data-index="reportDate" width="120" />
              <Table.Column title="项目" data-index="projectName" width="160" />
              <Table.Column title="监造员" data-index="reporter" width="100" />
            ...
            <Card v-for="record in reports" :key="record.id" size="small">
              ...
              >
                ...
                >
                  ...
                  <span v-if="item.dailyQuantity" class="text-xs text-green-600"
        ...
        <Card>
          ...
          <div class="hidden md:block">
            ...
            >
              ...
              <Table.Column title="项目" data-index="projectName" width="170" />
          ...
          <div class="space-y-3 md:hidden">
            <Card v-for="record in issues" :key="record.id" size="small">
              ...
              <div class="mt-2 flex flex-wrap gap-2">
                ...
                <Tag v-if="record.affectsProgress" color="orange">影响进度</Tag>
              </div>
    ...
    <Form layout="vertical">
      ...
      <div class="mb-4 rounded border border-blue-100 bg-blue-50 p-3">
        <div class="flex flex-wrap items-center justify-between gap-2">
          ...
          <Tag color="blue">已选择 {{ activeReportTaskDrafts.length }} 个</Tag>
        </div>
      </div>
      <div
        ...
        <div v-for="group in reportTaskGroups" :key="group.title">
          ...
          <div class="space-y-3">
            <div
              ...
              :class="draft.enabled ? 'border-blue-200 bg-white' : 'bg-gray-50'"
            >
  ...
  >
    <Form layout="vertical">
      ...
      <Form.Item label="整改要求">
        <Input.TextArea v-model:value="issueForm.correctiveAction" :rows="3" />
      </Form.Item>
