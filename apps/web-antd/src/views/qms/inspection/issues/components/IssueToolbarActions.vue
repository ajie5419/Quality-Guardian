...
export interface IssueToolbarActionsProps {
  canAddChart: boolean;
  canDelete: boolean;
  checkedCount: number;
...
const props = defineProps<IssueToolbarActionsProps>();
...
<template>
  <div class="flex flex-wrap items-center gap-2">
    ...
    >
      <span class="text-gray-500">{{ props.dateModeLabel }}:</span>
      <Select
      ...
      <Select
        ...
        :class="props.isMobile ? 'w-full' : 'w-[120px]'"
      ...
      <DatePicker
        ...
        :class="props.isMobile ? 'w-full' : 'w-[160px]'"
