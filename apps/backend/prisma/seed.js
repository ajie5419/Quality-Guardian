...
async function main() {
  ...
  const menuData = [
    ...
    },
    {
      id: 1500,
      parentId: 15,
      name: 'SystemAiSettingsView',
      type: 'button',
      authCode: 'System:AiSettings:View',
      meta: { title: '查看' },
    },
    {
      id: 1501,
      parentId: 15,
      name: 'SystemAiSettingsEdit',
      type: 'button',
      authCode: 'System:AiSettings:Edit',
      meta: { title: '修改配置' },
    },
    ...
    },
    {
      id: 2101,
      parentId: 21,
      name: 'QMSDashboardChartAdd',
      type: 'button',
      authCode: 'QMS:Dashboard:ChartAdd',
      meta: { title: '新增图表' },
    },
    {
      id: 2102,
      parentId: 21,
      name: 'QMSDashboardChartEdit',
      type: 'button',
      authCode: 'QMS:Dashboard:ChartEdit',
      meta: { title: '编辑图表' },
    },
    {
      id: 2103,
      parentId: 21,
      name: 'QMSDashboardChartDelete',
      type: 'button',
      authCode: 'QMS:Dashboard:ChartDelete',
      meta: { title: '删除图表' },
    },
    ...
    },
    {
      id: 3101,
      parentId: 31,
      name: 'QMSPlanningBOMCreate',
      type: 'button',
      authCode: 'QMS:Planning:BOM:Create',
      meta: { title: '新增' },
    },
    {
      id: 3102,
      parentId: 31,
      name: 'QMSPlanningBOMEdit',
      type: 'button',
      authCode: 'QMS:Planning:BOM:Edit',
      meta: { title: '编辑' },
    },
    {
      id: 3103,
      parentId: 31,
      name: 'QMSPlanningBOMDelete',
      type: 'button',
      authCode: 'QMS:Planning:BOM:Delete',
      meta: { title: '删除' },
    },
    {
      id: 3104,
      parentId: 31,
      name: 'QMSPlanningBOMExport',
      type: 'button',
      authCode: 'QMS:Planning:BOM:Export',
      meta: { title: '导出' },
    },
    {
      id: 3105,
      parentId: 31,
      name: 'QMSPlanningBOMImport',
      type: 'button',
      authCode: 'QMS:Planning:BOM:Import',
      meta: { title: '导入' },
    },
    ...
    },
    {
      id: 3201,
      parentId: 32,
      name: 'QMSPlanningDFMEACreate',
      type: 'button',
      authCode: 'QMS:Planning:DFMEA:Create',
      meta: { title: '新增' },
    },
    {
      id: 3202,
      parentId: 32,
      name: 'QMSPlanningDFMEAEdit',
      type: 'button',
      authCode: 'QMS:Planning:DFMEA:Edit',
      meta: { title: '编辑' },
    },
    {
      id: 3203,
      parentId: 32,
      name: 'QMSPlanningDFMEADelete',
      type: 'button',
      authCode: 'QMS:Planning:DFMEA:Delete',
      meta: { title: '删除' },
    },
    {
      id: 3204,
      parentId: 32,
      name: 'QMSPlanningDFMEAExport',
      type: 'button',
      authCode: 'QMS:Planning:DFMEA:Export',
      meta: { title: '导出' },
    },
    ...
    // --- 检验表模板 ---
    {
      id: 35,
      parentId: 30,
      path: '/qms/planning/inspection-forms',
      name: 'QMSPlanningInspectionForms',
      component: 'qms/planning/inspection-forms/index',
      type: 'menu',
      authCode: 'QMS:Planning:InspectionForm:List',
      meta: { title: '检验表模板', icon: 'carbon:document-multiple-02' },
    },
    {
      id: 3500,
      parentId: 35,
      name: 'QMSPlanningInspectionFormsView',
      type: 'button',
      authCode: 'QMS:Planning:InspectionForm:View',
      meta: { title: '查看' },
    },
    {
      id: 3501,
      parentId: 35,
      name: 'QMSPlanningInspectionFormsCreate',
      type: 'button',
      authCode: 'QMS:Planning:InspectionForm:Create',
      meta: { title: '新增' },
    },
    {
      id: 3502,
      parentId: 35,
      name: 'QMSPlanningInspectionFormsEdit',
      type: 'button',
      authCode: 'QMS:Planning:InspectionForm:Edit',
      meta: { title: '编辑' },
    },
    {
      id: 3503,
      parentId: 35,
      name: 'QMSPlanningInspectionFormsDelete',
      type: 'button',
      authCode: 'QMS:Planning:InspectionForm:Delete',
      meta: { title: '删除' },
    },
    ...
    },
    {
      ...
      type: 'button',
      authCode: 'QMS:Inspection:Records:Create',
      meta: { title: '新增' },
    },
    {
      id: 4102,
      ...
      type: 'button',
      authCode: 'QMS:Inspection:Records:Edit',
      meta: { title: '编辑' },
    },
    {
      id: 4103,
      ...
      type: 'button',
      authCode: 'QMS:Inspection:Records:Delete',
      meta: { title: '删除' },
    },
    {
      id: 4104,
      ...
      type: 'button',
      authCode: 'QMS:Inspection:Records:Export',
      meta: { title: '导出' },
    },
    {
      id: 4105,
      ...
      type: 'button',
      authCode: 'QMS:Inspection:Records:Import',
      meta: { title: '导入' },
    },
    ...
    },
    {
      ...
      type: 'button',
      authCode: 'QMS:Inspection:Issues:Create',
      meta: { title: '新增' },
    },
    {
      id: 4202,
    ...
    },
    {
      ...
      type: 'button',
      authCode: 'QMS:Inspection:Issues:Delete',
      meta: { title: '删除' },
    },
    {
      id: 4204,
    ...
    },
    {
      ...
      type: 'button',
      authCode: 'QMS:AfterSales:Create',
      meta: { title: '新增' },
    },
    {
      id: 5002,
    ...
    },
    {
      ...
      type: 'button',
      authCode: 'QMS:AfterSales:Delete',
      meta: { title: '删除' },
    },
    {
      id: 5004,
    ...
    },
    {
      id: 5101,
      parentId: 51,
      name: 'QMSSupplierCreate',
      type: 'button',
      authCode: 'QMS:Supplier:Create',
      meta: { title: '新增' },
    },
    {
      id: 5102,
      parentId: 51,
      name: 'QMSSupplierEdit',
      type: 'button',
      authCode: 'QMS:Supplier:Edit',
      meta: { title: '编辑' },
    },
    {
      id: 5103,
      parentId: 51,
      name: 'QMSSupplierDelete',
      type: 'button',
      authCode: 'QMS:Supplier:Delete',
      meta: { title: '删除' },
    },
    {
      id: 5104,
      parentId: 51,
      name: 'QMSSupplierExport',
      type: 'button',
      authCode: 'QMS:Supplier:Export',
      meta: { title: '导出' },
    },
    {
      id: 5105,
      parentId: 51,
      name: 'QMSSupplierImport',
      type: 'button',
      authCode: 'QMS:Supplier:Import',
      meta: { title: '导入' },
    },
    ...
    // --- 焊工管理 ---
    {
      ...
      path: '/qms/welder',
      name: 'QMSWelder',
      component: 'qms/welder/index',
      type: 'menu',
      authCode: 'QMS:Welder:List',
      meta: { title: '焊工管理', icon: 'carbon:user-avatar-filled-alt' },
    },
    {
      id: 5400,
      parentId: 54,
      name: 'QMSWelderView',
      type: 'button',
      authCode: 'QMS:Welder:View',
      meta: { title: '查看' },
    },
    {
      id: 5401,
      parentId: 54,
      name: 'QMSWelderCreate',
      type: 'button',
      authCode: 'QMS:Welder:Create',
      meta: { title: '新增' },
    },
    {
      id: 5402,
      ...
      name: 'QMSWelderEdit',
      type: 'button',
      authCode: 'QMS:Welder:Edit',
      meta: { title: '编辑' },
    },
    {
      id: 5403,
      parentId: 54,
      name: 'QMSWelderDelete',
      type: 'button',
      authCode: 'QMS:Welder:Delete',
      meta: { title: '删除' },
    },
    {
      id: 5404,
      parentId: 54,
      name: 'QMSWelderImport',
      type: 'button',
      authCode: 'QMS:Welder:Import',
      meta: { title: '导入' },
    },
    ...
    },
    {
      id: 5301,
      parentId: 53,
      name: 'QMSKnowledgeCreate',
      type: 'button',
      authCode: 'QMS:Knowledge:Create',
      meta: { title: '新增' },
    },
    {
      id: 5302,
      parentId: 53,
      name: 'QMSKnowledgeEdit',
      type: 'button',
      authCode: 'QMS:Knowledge:Edit',
      meta: { title: '编辑' },
    },
    {
      id: 5303,
      parentId: 53,
      name: 'QMSKnowledgeDelete',
      type: 'button',
      authCode: 'QMS:Knowledge:Delete',
      meta: { title: '删除' },
    },
    ...
    },
    {
      id: 6101,
      parentId: 61,
      name: 'QMSLossAnalysisCreate',
      type: 'button',
      authCode: 'QMS:LossAnalysis:Create',
      meta: { title: '新增' },
    },
    {
      id: 6102,
      parentId: 61,
      name: 'QMSLossAnalysisEdit',
      type: 'button',
      authCode: 'QMS:LossAnalysis:Edit',
      meta: { title: '编辑' },
    },
    {
      id: 6103,
      parentId: 61,
      name: 'QMSLossAnalysisDelete',
      type: 'button',
      authCode: 'QMS:LossAnalysis:Delete',
      meta: { title: '删除' },
    },
    {
      id: 6104,
      parentId: 61,
      name: 'QMSLossAnalysisExport',
      type: 'button',
      authCode: 'QMS:LossAnalysis:Export',
      meta: { title: '导出' },
    },
    {
      id: 6105,
      parentId: 61,
      name: 'QMSLossAnalysisImport',
      type: 'button',
      authCode: 'QMS:LossAnalysis:Import',
      meta: { title: '导入' },
    },
    ...
    },
    {
      id: 6201,
      parentId: 62,
      name: 'QMSDailyReportsExport',
      type: 'button',
      authCode: 'QMS:Reports:Daily:Export',
      meta: { title: '导出' },
    },
    ...
    },
    {
      id: 6300,
      parentId: 63,
      name: 'QMSReportSummaryView',
      type: 'button',
      authCode: 'QMS:Reports:Summary:View',
      meta: { title: '查看' },
    },
    {
      id: 6301,
      parentId: 63,
      name: 'QMSReportSummaryExport',
      type: 'button',
      authCode: 'QMS:Reports:Summary:Export',
      meta: { title: '导出' },
    },
  ];
  ...
  console.log(
    `📋 共定义 ${menuData.length} 个菜单/按钮，${allAuthCodes.length} 个权限码`,
  );
  ...
  console.warn('✅ 权限系统初始化完成！所有页面和按钮权限已就绪。');
}
