...
async function main() {
  ...
  const menuData = [
    ...
    // --- 计量器具管理 ---
    {
      ...
      type: 'catalog',
      meta: { title: '计量器具管理', icon: 'carbon:ruler-alt' },
    },
    {
      id: 56,
      parentId: 55,
      ...
      meta: { title: '计量器具台账', icon: 'carbon:notebook' },
    },
    {
      id: 5600,
      parentId: 56,
    ...
    },
    {
      ...
      meta: { title: '计量器具校准计划', icon: 'carbon:calendar' },
    },
    {
      id: 5700,
      parentId: 57,
    ...
    },
    {
      ...
      meta: { title: '量具借用管理', icon: 'carbon:qr-code' },
    },
    {
      id: 5800,
      parentId: 58,
